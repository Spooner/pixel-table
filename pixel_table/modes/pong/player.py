...
class Player(BasePlayer):
    ...
    def __init__(self, index):
        if index == 0:
            ...
            score_x, score_y, score_is_vertical, score_is_inverted = 0, 15, False, False
        elif index == 1:
            x, y, width, height, self._move_left = 6, 1, 3, 1, (1, 0)
            score_x, score_y, score_is_vertical, score_is_inverted = 15, 0, False, True
        elif index == 2:
            x, y, width, height, self._move_left = 1, 7, 1, 3, (0, -1)
            score_x, score_y, score_is_vertical, score_is_inverted = 0, 0, True, False
        elif index == 3:
            x, y, width, height, self._move_left = 14, 6, 1, 3, (0, 1)
            score_x, score_y, score_is_vertical, score_is_inverted = 15, 15, True, True
        else:
            raise ValueError
        ...
        self._score = Score(x=score_x, y=score_y, is_inverted=score_is_inverted, is_vertical=score_is_vertical,
                            value=3)
